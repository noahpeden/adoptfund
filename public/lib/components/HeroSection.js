  ...
  render() {
    return (
      <div className='main-section-container'>
        ...
        <h3 className='hero-h3'>Helping Families Grow</h3>
        <Button className='main-start-family-btn' handleClick={() => this.checkRoute()} text='Start Family Fund'/>
        <input className='search-family-input' placeholder='Search for a Family Name' onChange={(e) => this.setState({searchText: e.target.value})} />
